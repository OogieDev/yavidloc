...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			// Mnkitchen
            if ($this->user->hasPermission('access', 'mnkitchen/kitchen')) {
                $catalog[] = array(
                    'name' => $this->language->get('text_kitchen'),
			...
			if ($this->user->hasPermission('access', 'mnblog/blog')) {
				$mnblog[] = array(
            ...
            if ($this->user->hasPermission('access', 'mnservices/services')) {
                $mnservices[] = array(
            ...
            if ($this->user->hasPermission('access', 'mnstock/stock')) {
                $mnstock[] = array(
