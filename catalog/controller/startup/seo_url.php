...
class ControllerStartupSeoUrl extends Controller
{
    ...
    if (isset($this->request->get['_route_'])) {
      ...
      foreach ($parts as $part) {
        ...
        if ($query->num_rows) {
          ...
          if ($url[0] == 'kitchen_id') {
            $this->request->get['kitchen_id'] = $url[1];
          }

          if ($url[0] == 'stock_id') {
            $this->request->get['stock_id'] = $url[1];
          }
          ...
          if ($query->row['query'] && $url[0] != 'information_id' && $url[0] != 'manufacturer_id' && $url[0] != 'category_id' && $url[0] != 'product_id' && $url[0] != 'article_id' && $url[0] != 'service_id' && $url[0] != 'stock_id' && $url[0] != 'kitchen_id') {
      ...
      if (!isset($this->request->get['route'])) {
        if (isset($this->request->get['product_id'])) {
        ...
        } elseif (isset($this->request->get['kitchen_id'])) {
          $this->request->get['route'] = 'mnkitchen/kitchen';
          ...
          $this->request->get['route'] = 'mnblog/blog';
        } elseif (isset($this->request->get['service_id'])) {
          $this->request->get['route'] = 'mnservices/services';
        } elseif (isset($this->request->get['stock_id'])) {
          $this->request->get['route'] = 'mnstock/stock';
        }
      }
      // Redirect 301
      ...
      } else if ($this->request->get['route'] == 'mnkitchen/kitchen' && isset($this->request->get['kitchen_id'])) {
        $route = 'kitchen_id=' . (int)$this->request->get['kitchen_id'];
  ...
  public function rewrite($link)
  {
    ...
    foreach ($data as $key => $value) {
      ...
      if (isset($data['route'])) {
        if (($data['route'] == 'product/product' && $key == 'product_id') || ($data['route'] == 'mnkitchen/kitchen' && $key == 'kitchen_id') || (($data['route'] == 'product/manufacturer/info' || $data['route'] == 'product/product') && $key == 'manufacturer_id') || ($data['route'] == 'information/information' && $key == 'information_id')) {
